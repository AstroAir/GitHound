...
class TestSimpleServer:
    ...
    @pytest.mark.asyncio
    async def test_simple_server_tools(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_echo_tool(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_add_numbers_tool(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_get_server_info_tool(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_simulate_error_tool(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_simple_server_resources(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_server_info_resource(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_config_resource(self, simple_mcp_client):
        """Test config resource."""
        content = await simple_mcp_client.read_resource("simple://config/settings")
    ...
    @pytest.mark.asyncio
    async def test_status_resource(self, simple_mcp_client):
...
class TestGitHoundServer:
    ...
    @pytest.mark.asyncio
    async def test_githound_server_tools(self, githound_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_analyze_repository_tool(self, githound_mcp_client, temp_git_repo):
    ...
    @pytest.mark.asyncio
    async def test_get_commit_history_tool(self, githound_mcp_client, temp_git_repo):
    ...
    @pytest.mark.asyncio
    async def test_get_author_stats_tool(self, githound_mcp_client, temp_git_repo):
    ...
    @pytest.mark.asyncio
    async def test_get_file_history_tool(self, githound_mcp_client, temp_git_repo):
    ...
    @pytest.mark.asyncio
    async def test_githound_server_resources(self, githound_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_repository_summary_resource(self, githound_mcp_client, temp_git_repo):
    ...
    @pytest.mark.asyncio
    async def test_contributors_resource(self, githound_mcp_client, temp_git_repo):
...
class TestServerErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_invalid_repository_path(self, githound_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_invalid_commit_hash(self, githound_mcp_client, temp_git_repo):
    ...
    @pytest.mark.asyncio
    async def test_invalid_file_path(self, githound_mcp_client, temp_git_repo):
    ...
    @pytest.mark.asyncio
    async def test_invalid_resource_uri(self, githound_mcp_client):
...
class TestServerPerformance:
    ...
    @pytest.mark.asyncio
    async def test_tool_execution_performance(self, simple_mcp_client, performance_thresholds):
    ...
    @pytest.mark.performance
    @pytest.mark.asyncio
    async def test_resource_access_performance(self, simple_mcp_client, performance_thresholds):
    ...
    @pytest.mark.performance
    @pytest.mark.asyncio
    async def test_concurrent_requests(self, simple_mcp_client):
...
class TestServerConfiguration:
    ...
    def test_simple_server_app_creation(self):
    ...
    def test_githound_server_app_creation(self):
    ...
    def test_githound_server_mock_mode(self):
...
class TestServerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_workflow_simple_server(self, simple_mcp_client):
    ...
    @pytest.mark.asyncio
    async def test_full_workflow_githound_server(self, githound_mcp_client, temp_git_repo):
