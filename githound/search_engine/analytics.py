...
class SearchAnalytics:
    ...
    async def get_performance_metrics(
        ...
        metrics = PerformanceMetrics(
            ...
            avg_results_per_search=sum(event.result_count for event in relevant_events) / len(relevant_events),
            ...
            avg_memory_usage_mb=sum(
                event.memory_usage_mb or 0 for event in relevant_events
            ) / len(relevant_events),
    ...
    async def get_usage_patterns(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "search_type_trends": {
                k: len(set(v)) for k, v in search_type_trends.items()
            },
