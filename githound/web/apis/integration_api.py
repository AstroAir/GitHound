...
async def export_search_results(
    ...
    try:
        ...
        filename = export_request.filename or f"search_results_{export_request.search_id}.{export_request.format.value}"
...
async def batch_export_search_results(
    ...
    try:
        ...
        filename = f"batch_export_{len(batch_request.search_ids)}_searches.{batch_request.format.value}"
