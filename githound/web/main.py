...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {
            "name": "search",
            "description": "Advanced search capabilities across Git repositories",
        },
        {
            "name": "analysis",
...
async def register(
    request: Request, user_data: UserCreate, request_id: str = get_request_id()
) -> ApiResponse:
    """Register a new user."""
    try:
...
async def logout(request: Request, request_id: str = get_request_id()) -> ApiResponse:
