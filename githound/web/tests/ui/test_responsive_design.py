...
class TestResponsiveDesign:
    ...
    async def test_search_results_responsive(self, page: Page, authenticated_user, test_repository):
        ...
        for viewport in viewports:
            ...
            assert container_box["width"] <= viewport["width"], f"Results should fit {viewport['name']} width"
            ...
            if await result_cards.count() > 0:
                ...
                assert card_box["width"] <= viewport["width"] - 40, f"Result cards should fit {viewport['name']} with margin"
    ...
    async def test_form_elements_responsive(self, page: Page, authenticated_user):
        ...
        for viewport in viewports:
            ...
            assert repo_box["width"] <= viewport["width"] - 40, "Repo input should fit viewport with margin"
            assert query_box["width"] <= viewport["width"] - 40, "Query input should fit viewport with margin"
            ...
            assert button_box["width"] <= viewport["width"] - 40, "Submit button should fit viewport"
    ...
    async def test_table_responsive(self, page: Page, authenticated_user, test_repository):
        ...
        if await results_table.is_visible():
            ...
            if table_box["width"] > 375:
                ...
                assert overflow_x in ["auto", "scroll"], "Wide table should be horizontally scrollable on mobile"
        else:
        ...
        for viewport in viewports:
            ...
            for i in range(image_count):
                ...
                if await image.is_visible():
                    ...
                    assert image_box["width"] <= viewport["width"], f"Image should fit viewport width"
    ...
    async def test_text_readability_responsive(self, page: Page, authenticated_user):
        ...
        for viewport in viewports:
            ...
            if line_height != "normal":
                ...
                assert line_height_value >= font_size_px * 1.2, f"Line height should be at least 1.2x font size on {viewport['name']}"
    ...
    async def test_touch_targets_mobile(self, page: Page, authenticated_user):
        ...
        for i in range(min(link_count, 10)):  # Check first 10 links
            ...
            if await link.is_visible():
                ...
                assert link_box["height"] >= 44 or link_box["width"] >= 44, \
