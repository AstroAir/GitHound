...
class TestAPIIntegration:
    ...
    async def test_search_api_through_frontend(self, page: Page, authenticated_user, test_repository):
    ...
    async def test_api_authentication_headers(self, page: Page, authenticated_user, test_repository):
