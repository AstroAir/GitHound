...
class WebhookDelivery(BaseModel):
    ...
    duration_ms: Optional[float] = Field(None, description="Delivery duration")
...
class WebhookManager:
    ...
    def get_delivery_history(self, endpoint_id: Optional[str] = None, limit: int = 100) -> List[WebhookDelivery]:
