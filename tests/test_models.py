...
class TestSearchQuery:
    ...
    def test_search_query_date_range(self):
...
class TestSearchResult:
    ...
    def test_search_result_with_commit_info(self):
...
class TestSearchConfig:
    ...
    def test_search_config_defaults(self):
        ...
        assert config.max_results is None  # Fixed: defaults to None, not 1000
        assert config.timeout_seconds is None  # Fixed: defaults to None, not 60
