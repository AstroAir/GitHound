...
""")
        ...
        feature_file.write_text("""\"\"\"New feature module.\"\"\"
...
def sample_search_queries() -> dict:
    ...
    return {
        ...
        "message_search": SearchQuery(
            message_pattern="Add.*file",
            fuzzy_search=False
        ),
        "fuzzy_search": SearchQuery(
            content_pattern="functon",  # Typo intentional
            fuzzy_search=True,
            fuzzy_threshold=0.8
        ),
...
def mock_githound_instance():
    ...
    mock_gh.analyze_blame.return_value = Mock(
        ...
        lines=[
            ...
            Mock(line_number=2, content='"""Main module for the test application."""', author="Test User")
        ]
    )
