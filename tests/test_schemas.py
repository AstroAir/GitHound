...
class TestExportOptions:
    ...
    def test_export_options_creation(self) -> None:
...
class TestSortCriteria:
    ...
    def test_sort_criteria_creation(self) -> None:
        """Test creating SortCriteria."""
        sort = SortCriteria(field="date", order=SortOrder.DESC)  # Fixed: ascending -> order
...
class TestDataFilter:
    ...
    def test_data_filter_creation(self) -> None:
        """Test creating DataFilter."""
        filter_obj = DataFilter(field="author", operator="contains", value="john")
...
class TestAuthorSchema:
    ...
    def test_author_schema_creation(self) -> None:
        ...
        author = AuthorSchema(
            name="John Doe", email="john@example.com", commits_count=50, lines_authored=1000
        )
...
class TestBranchSchema:
    ...
    def test_branch_schema_creation(self) -> None:
        """Test creating BranchSchema."""
        branch = BranchSchema(name="main", commit_hash="abc123", is_remote=False)  # Required field
...
class TestTagSchema:
    ...
    def test_tag_schema_creation(self) -> None:
        """Test creating TagSchema."""
        tag = TagSchema(name="v1.0.0", commit_hash="abc123", message="Release version 1.0.0")
...
class TestFileChangeSchema:
    ...
    def test_file_change_schema_creation(self) -> None:
...
class TestCommitSchema:
    ...
    def test_commit_schema_creation(self) -> None:
...
class TestBlameLineSchema:
    ...
    def test_blame_line_schema_creation(self) -> None:
...
class TestFileBlameSchema:
    ...
    def test_file_blame_schema_creation(self) -> None:
...
class TestDiffLineSchema:
    ...
    def test_diff_line_schema_creation(self) -> None:
...
class TestFileDiffSchema:
    ...
    def test_file_diff_schema_creation(self) -> None:
        """Test creating FileDiffSchema."""
        diff_line = DiffLineSchema(line_number=1, content="# Test file", change_type="added")
...
class TestCommitDiffSchema:
    ...
    def test_commit_diff_schema_creation(self) -> None:
...
class TestRepositorySchema:
    ...
    def test_repository_schema_creation(self) -> None:
...
class TestSearchResultSchema:
    ...
    def test_search_result_schema_creation(self) -> None:
...
class TestSearchResultsCollectionSchema:
    ...
    def test_search_results_collection_schema_creation(self) -> None:
