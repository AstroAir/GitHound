...
class TestCreateAuthorizationProvider:
    ...
    def test_create_eunomia_provider_available(self, mock_eunomia):
        ...
        assert provider is not None
        mock_eunomia.assert_called_once_with(
            base_provider,
            policy_file="test_policies.json"
        )
    ...
    def test_create_permit_provider_available(self, mock_permit):
        ...
        assert provider is not None
        mock_permit.assert_called_once_with(
            base_provider,
            permit_api_key="test-api-key"
        )
...
class TestGetAvailableProviders:
    ...
    def test_get_available_providers(self):
        ...
        for provider_info in auth_providers.values():
            ...
            assert provider_info["available"] is True  # Core providers should always be available
