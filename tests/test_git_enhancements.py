...
class TestGitHandler:
    ...
    def test_extract_commit_metadata(self, temp_repo):
    ...
    def test_get_repository_metadata(self, temp_repo):
    ...
    def test_get_commits_with_filters(self, temp_repo):
        ...
        assert any(commit.hexsha == initial_commit.hexsha for commit in commits)
...
class TestGitBlame:
    ...
    def test_get_file_blame(self, temp_repo):
    ...
    def test_get_line_history(self, temp_repo):
    ...
    def test_get_author_statistics(self, temp_repo):
...
class TestGitDiff:
    ...
    def test_compare_commits(self, temp_repo):
    ...
    def test_get_file_diff_history(self, temp_repo):
...
class TestErrorHandling:
    ...
    def test_invalid_file_blame(self, temp_repo):
    ...
    def test_invalid_commit_comparison(self, temp_repo):
    ...
    def test_invalid_branch_comparison(self, temp_repo):
...
class TestEdgeCases:
    ...
    def test_empty_repository_metadata(self):
    ...
    def test_binary_file_diff(self, temp_repo):
