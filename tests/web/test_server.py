...
class TestWebServer:
    ...
    def test_serve_command_defaults(self, mock_uvicorn_run):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_command_custom_params(self, mock_uvicorn_run):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_command_with_workers_no_reload(self, mock_uvicorn_run):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_command_keyboard_interrupt(self, mock_uvicorn_run):
    ...
    def test_serve_command_exception(self, mock_sys_exit, mock_uvicorn_run):
    ...
    def test_dev_command(self, mock_serve):
        """Test dev command."""
    ...
    @patch('githound.web.server.serve')
    def test_prod_command_defaults(self, mock_serve):
    ...
    @patch('githound.web.server.serve')
    def test_prod_command_custom_params(self, mock_serve):
    ...
    def test_prod_command_help(self):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_output_messages(self, mock_uvicorn_run):
    ...
    @patch('githound.web.server.serve')
    def test_dev_output_messages(self, mock_serve):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_port_validation(self, mock_uvicorn_run):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_host_validation(self, mock_uvicorn_run):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_log_level_validation(self, mock_uvicorn_run):
    ...
    @patch('githound.web.server.uvicorn.run')
    def test_serve_workers_validation(self, mock_uvicorn_run):
