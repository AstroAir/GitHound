...
class TestWebAPI:
    ...
    def test_search_endpoint_basic(self):
        ...
        with patch('githound.web.api.get_repository') as mock_get_repo:
            with patch('githound.web.api.SearchOrchestrator') as mock_orchestrator_class:
                ...
                async def mock_search(repo, query):
                    yield SearchResult(
                        commit_hash="abc123",
                        file_path="test.py",
                        line_number=10,
    ...
    def test_search_endpoint_invalid_repo(self):
    ...
    def test_cancel_search_endpoint(self):
    ...
    def test_cancel_search_not_found(self):
        ...
        with patch.dict('githound.web.api.active_searches', {
            ...
            with patch('githound.web.api.get_export_manager') as mock_get_export:
                ...
                try:
                    ...
                    def mock_export_to_json(results, export_path, include_metadata):
...
class TestActiveSearchState:
    ...
    def test_active_search_state_creation(self):
    ...
    def test_active_search_state_with_data(self):
