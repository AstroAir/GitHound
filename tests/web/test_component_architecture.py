...
class TestComponentArchitecture:
    ...
    def test_directory_structure_exists(self, static_dir, components_dir, styles_dir):
        ...
        assert (
            components_dir / "websocket"
        ).exists(), "WebSocket components directory should exist"
        ...
        for js_file in js_files:
            ...
            if re.search(import_pattern, content):
                ...
                for import_stmt in imports:
                    assert (
                        ".js" in import_stmt
                    ), f"Import in {js_file.name} should include .js extension: {import_stmt}"
    ...
    def test_component_base_class_usage(self, components_dir):
        ...
        for file_path in component_files:
            ...
            assert (
                "import { Component }" in content
            ), f"{file_path} should import Component base class"
    ...
    def test_css_syntax_valid(self, styles_dir):
        ...
        for css_file in css_files:
            ...
            if "--" in content:
                ...
                if var_definitions:
                    assert (
                        len(var_usage) > 0 or "variables.css" in css_file.name
